...
const s = {
  ...
  saldoLabel: { color: '#4A4E6A', fontSize: '0.75rem', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '6px' },
  saldoValor: { color: '#F0F1F4', fontSize: '1.8rem', fontWeight: '800', letterSpacing: '-0.03em' },
  card: {
    backgroundColor: '#131620',
    border: '1px solid #1F2235',
    borderRadius: '12px',
  ...
  step: { color: '#F0F1F4', fontWeight: '600', fontSize: '0.95rem', marginBottom: '16px' },
  ...
  destinoNome: { display: 'block', color: '#F0F1F4', fontWeight: '600', fontSize: '0.9rem' },
  destinoId: { display: 'block', color: '#4A4E6A', fontSize: '0.75rem', marginTop: '2px' },
  trocarBtn: {
    background: 'none',
    border: 'none',
    color: '#4361EE',
  ...
  cifrao: { color: '#8B8FA8', fontSize: '1.1rem', fontWeight: '600', flexShrink: 0 },
  valorInput: {
    flex: 1,
    background: 'none',
    border: 'none',
